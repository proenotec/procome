...
if __name__ == '__main__' :
  ...
  # **** Crear y abrir el formulario principal (versión Qt) ********************************************************************

  g_oFormPpal= PROCOME_FormPpal_Qt.FormPpal(g_iNrMedidas, g_iNrEstadosDig, g_iNrOrdenes, g_iDirProtocolo, g_oCSerie, g_oFichCfg)
