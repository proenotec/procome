...
class PROCOME_ConstruirTramaRcp:
  ...
  #
  # Devuelve:
  #    Un valor negativo si se ha detectado alg�n error 
  #    0: si a�n la trama no est� completa
    ...
    if( sSuperEstado == 'Comun') :
      ...
      # �����������������������������������������������������������������������������������������������������������������������
        ...
        if (byDatoRcp == PROCOME_General.TRAMACORTA_START) : 
          ...
          self._lEstado= ['Comun', 'Error']
          if (self._bVerMensDbg_ErrorReal) : print('ERROR en "PROCOME_ConstruirTramaRcp": Carácter "START" no válido. Caracter= ' + Hex2(byDatoRcp)+ '>')
          return -11  
      ...
      # �����������������������������������������������������������������������������������������������������������������������
        ...
        if (byDatoRcp != self._iChecksum) :
          self._lEstado= ['Comun', 'Error']
          if (self._bVerMensDbg_ErrorReal) : print('ERROR en "PROCOME_ConstruirTramaRcp": Checksum no válido. Recibido= ' + Hex2(byDatoRcp)+ '. Calculado= ' + Hex2(self._iChecksum)+ '>')
      ...
      # �����������������������������������������������������������������������������������������������������������������������
        ...
        if (bHayError) :
          self._lEstado= ['Comun', 'Error']
          if (self._bVerMensDbg_ErrorReal) : print('ERROR en "PROCOME_ConstruirTramaRcp": Carácter "END" no válido. Caracter= ' + Hex2(byDatoRcp)+ '>')
          if (self._bVerMensDbg_TramaParcial) : ImprimirTrama_Hex(' - Trama parcial: ', self._lTrama)
          return -13
    ...
    # -------------------------------------------------------------------------------------------------------------------------
      ...
      # �����������������������������������������������������������������������������������������������������������������������
        ...
        if (byDatoRcp != PROCOME_General.TRAMALARGA_START) :
          if (self._bVerMensDbg_ErrorReal) : print('ERROR en "PROCOME_ConstruirTramaRcp": Segundo carácter "START" de una trama larga no válido. Caracter= ' + Hex2(byDatoRcp)+ '>')
          if (self._bVerMensDbg_TramaParcial) : ImprimirTrama_Hex(' - Trama parcial: ', self._lTrama)
          return -33
