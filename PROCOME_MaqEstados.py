...
class PROCOME_MaqEstados:
  ...
  # - Un texto con la descripción de un error
  ...
  def ProcesarEventos(self, sEvento, xDato= None):
    ...
    # =========================================================================================================================
    # ==== Procesar en función del estado actual
    # =========================================================================================================================
    ...
    while(sEvento != 'Procesado') :
      ...
      if (sSuperEstado == 'Enlace') :
          ...
          if (sEvento == 'Arrancar') :
            if (self._oCanalSerie.is_open) :
              ...
              try :
                ...
                self._CancelarLaComunicacion()
                return 'ERROR: Al intentar abrir el canal serie <'  + self._oCanalSerie.port + '>. Puede ser que ese canal serie no exista o que esté ocupado'
                #
            ...
            self._oCanalSerie.reset_output_buffer() # Borrar lo que haya en el buffer de transmisión
            self._oCanalSerie.rts= False            # Desactivar la señal RTS para no permitir la transmisión por el RS485
        ...
        # ·····················································································································
          ...
          # **** Estado de la comunicación= Preparando la transmisión *********************************************************
          ...
          # **** Estado de la comunicación= Esperando mensaje de recepción *****************************************************

          elif (self._sEstadoCom == 'EspRcp') :
        
            # ==== Evento= Recibida trama válida ===============================================================================
  ...
  def _Reintentar(self):
    ...
    if (self._iIntentosTrmQuedan > 0) :
      ...
      # Cancelar cualquier Temporización en marcha
  ...
  # ===========================================================================================================================
  #
  # Al ser un mensaje que se envia sin esperar confirmación se prepara la transmisión, se transmite, se espera un pequeño tiempo
