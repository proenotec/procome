...
class PROCOME_MaqEstados:
  ...
  # - Un texto con la descripci�n de un error
  ...
  def ProcesarEventos(self, sEvento, xDato= None):
    ...
    # =========================================================================================================================
    # ==== Procesar en funci�n del estado actual
    # =========================================================================================================================
      ...
      if (sSuperEstado == 'Enlace') :
        ...
        if (sEstado == 'Reposo') :
          ...
          if (sEvento == 'Arrancar') :
            ...
            self._oCanalSerie.reset_output_buffer() # Borrar lo que haya en el buffer de transmisi�n
            self._oCanalSerie.rts= False            # Desactivar la se�al RTS para no permitir la transmisi�n por el RS485
        ...
        # ���������������������������������������������������������������������������������������������������������������������
          ...
          # **** Estado de la comunicaci�n= Preparando la transmisi�n *********************************************************
          ...
          # **** Estado de la comunicaci�n= Transmitir el mensaje *************************************************************
          ...
          # **** Estado de la comunicaci�n= Esperando mensaje de recepci�n *****************************************************

          elif (self._sEstadoCom == 'EspRcp') :
        
            # ==== Evento= Recibida trama v�lida ===============================================================================
  ...
  # ***************************************************************************************************************************
  # **** Hacer reintentos de la comunicaci�n 
  # ***************************************************************************************************************************
  ...
  def _Reintentar(self):
    ...
    if (self._iIntentosTrmQuedan > 0) :
      ...
      # Cancelar cualquier Temporizaci�n en marcha
  ...
  # ===========================================================================================================================
  #
  # Al ser un mensaje que se envia sin esperar confirmaci�n se prepara la transmisi�n, se transmite, se espera un peque�o tiempo
