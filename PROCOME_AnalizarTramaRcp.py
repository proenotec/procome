...
# =============================================================================================================================
# ==== ASDU 100 (Petici�n de medidas y cambios de estado)
# =============================================================================================================================
...
def InterpretarPaquetesSecundario_ASDU_103(lTrama):
  ...
  # **** Interpretar la informaci�n que viene en el ASDU **********************************************************************
  
  # Hora= lAsdu[7:14] # Se ignora la informaci�n de hora
...
def InterpretarPaquetesSecundario_ASDU_121(lTrama):
  ...
  if (iTipoOperacion == 1) :
    ...
    sTipoOperacion= 'ERROR: Tipo de operación no contemplado'
  ...
  if (iResultadoOper == 0) :
    ...
    sResultadoOper= 'El elemento ya está en la posición deseada'
    ...
    sResultadoOper= 'Error, opción no contemplada'
...
# =============================================================================================================================
# ==== ASDU 5 (Mensaje de identificaci�n del tipo de equipo)
# =============================================================================================================================
...
def InterpretarPaquetesSecundario_ASDU_5(lTrama):
  ...
  # El lAsdu[:2] es la COT, pero aunque hay varios valores v�lidos no nos interesan
  ...
  if (iTipoMensaje == 3) :
    ...
    sTipoMensaje= 'Con código <' + str(iTipoMensaje) + '>'
