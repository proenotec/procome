...
# **** Salir de la aplicaci�n cerrando todo ***********************************************************************************
...
if __name__ == '__main__' :
  ...
  # **** Cargar la configuraci�n del fichero de configuraci�n *****************************************************************

  sRta= g_oFichCfg.LeerDeFichero()
  if (sRta != '') :
    print('Leer el fichero de configuraci�n:')
    print(sRta)
    print('- Se arranca con la configuraci�n por defecto')
  ...
  # ==== Traese la configuraci�n por defecto, para partir de ella ==============================================================

  dCSerie_Parametros= g_oCSerie.get_settings()

  # ==== Configurar los par�metros antes de intentar arrancar el puerto ========================================================
  ...
  dCSerie_Parametros['timeout']=  0              #  - No se espera si no hay ning�n caracter en el buffer de recepci�n
  dCSerie_Parametros['write_timeout']=  0        #  - No se espera a que se transmita todo lo que hay en el buffer de transmisi�n
  dCSerie_Parametros['inter_byte_timeout']= None #  - Timeout entre caracteres consecutivos en recepci�n desactivado
